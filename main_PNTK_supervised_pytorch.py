...
def main():
    ...
    model_functorch = SupervisedModel_1D_PNTK_functorch(model, args.n_classes, args.max_epochs, args.batch_size, args.optimizer, args.lars, args.lr, args.weight_decay)
