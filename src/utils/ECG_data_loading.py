...
def Data_preprocessing(args):
    """ Preprocessing """
    data_folder = os.path.normpath("/mnt/scratch07/yilong") if args.cluster_name in ["b1", "b4"] else os.path.normpath("/mnt/group1/yilong/JET-Detection-Data")
    ...
    feature_df_all_selected_with_ecg = pd.read_csv(os.path.join(data_folder_2, "feature_df_all_selected_with_ecg_20220201.csv"))
