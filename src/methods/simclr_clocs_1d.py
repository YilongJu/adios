...
class SimCLR_CLOCS_1D(BaseModel):
    def __init__(
        self,
        output_dim: int,
        proj_hidden_dim: int,
        ...
        **kwargs
        ...
        """Implements SimCLR (https://arxiv.org/abs/2002.05709) with CLOCS (https://arxiv.org/abs/2005.13249).
    ...
    def add_model_specific_args(parent_parser: argparse.ArgumentParser) -> argparse.ArgumentParser:
        parent_parser = super(SimCLR_CLOCS_1D, SimCLR_CLOCS_1D).add_model_specific_args(parent_parser)
