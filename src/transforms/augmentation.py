""" Adapted from https://github.com/uchidalab/time_series_augmentation
All of the augmentation methods expect a numpy array x of size (batch,
time_steps, channel) where batch is the size of the dataset or batch,
time_steps is the number of time steps, and channel is the number of
dimensions. Even if 1D time series are used, channel should still be 1.
"""

import numpy as np
from tqdm import tqdm
import src.transforms.dtw as dtw
